...
-- Trigger function for fault comment mentions → dispatch notification
...
-- Create trigger on fault_comments INSERT
DROP TRIGGER IF EXISTS trigger_fault_comment_mentions ON fault_comments;
CREATE TRIGGER trigger_fault_comment_mentions
  AFTER INSERT ON fault_comments
  FOR EACH ROW
  EXECUTE FUNCTION notify_fault_comment_mentions();

-- Trigger function for fault_cases assignment change
...
DROP TRIGGER IF EXISTS trigger_fault_assigned ON fault_cases;
CREATE TRIGGER trigger_fault_assigned
  AFTER UPDATE ON fault_cases
  FOR EACH ROW
  EXECUTE FUNCTION notify_fault_assigned();
