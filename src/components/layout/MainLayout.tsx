    ...
    <SidebarProvider defaultOpen={defaultOpen}>
      <div className="min-h-screen flex w-full">
        ...
        <div className="flex-1 flex flex-col min-h-screen">
          ...
          <header className="sticky top-0 z-40 bg-sidebar text-sidebar-foreground md:border-b md:border-border md:bg-background/95 md:text-foreground md:backdrop-blur md:supports-[backdrop-filter]:bg-background/60">
